    ...
    public void UserRegister(View view) {
        if (txtName.getText().toString().isEmpty()) {
           ...
           // startActivity(new Intent(New_User_Acitvity.this, Admin_Home_Acitvity.class));
            Toast.makeText(New_User_Acitvity.this, "Name :"+txtName.getText().toString()+
                    "\nMobileNo :"+txtMobileNo.getText().toString()+
                    "\nCity :"+txtCity.getText().toString()+"\nGender :"+txtGender+
                    "\nUserName :"+ txtUserName.getText().toString()+"\nPassword :"+txtUserPassword.getText().toString(), Toast.LENGTH_LONG).show();
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            txtName.getText().clear();txtMobileNo.getText().clear();txtCity.getText().clear();txtGender.getText().clear();
                            txtUserName.getText().clear();txtUserPassword.getText().clear();
                        }
